...
사용자는 문장의 맨 처음에 괄호 안에 출력되길 원하는 언어의 종류를 쓸 것이다.
사용자가 입력한 첫 번째 괄호에 있는 언어의 종류를 인식해 뒤에 따르는 문장을 그 언어로 번역하면 된다.

사용자가 입력한 언어 외의 언어를 결과값에 절대 포함시키지 마라.
...
마지막으로 문장을 자연스럽게 번역했는지 확인해라.
고칠 부분이 있는 경우 정확하게 고친 후에 결과값을 내보내라.
"""
                },
                {
                    "role": "user",
