...
사용자가 입력한 (출력될 언어) 문장에서 괄호 안에 있는 언어로 문장을 자연스럽게 번역해라.

번역된 결과만 출력해라.

출력할 결과값에는 사용자가 입력한 (출력될 언어) 외의 언어를 절대 포함시키지 마라.
예를 들어, 사용자가 (한국어)를 입력했으면 그 외의 언어인 영어, 일본어, 중국어 등 한국어를 제외한 모든 언어를 포함시키지 마라.
"""
                },
                {
                    "role": "user",
